...
if __name__ == '__main__':
    ...
    expressao = 10 > 2 and 5 < 7
    print(expressao)
    expressao = 1 > 3 and 4 < 9
    print(expressao)

    # or
    # or retorna True se ao menos 1 dos lados da expressão for verdadeiro
    expressao = 100 < 3 or 2 > 0
    print(expressao)

    # not
    # not nega um valor (ou expressão)
    expressao = not 100 > 10
    print(expressao)
    expressao = not 10 > 1000
    print(expressao)
    ...
    print("banana" in texto)
    print("table" in texto)
    print("carne" not in texto)